...
class EmailExistenceValidator:
    def __init__(self):
        ...
        self.proxies = {
            "http": "http://188.40.59.208:3128",
            "http": "http://185.105.91.62:4444",
            "http": "http://185.105.89.249:4444",
            "http": "http://72.10.164.178:23465",
        }  # Add your proxies here

        self.proxy_auth = HTTPProxyAuth("", "")  # If your proxy requires authentication
        ...
        for mx in mx_records:
            ...
            try:
                with smtplib.SMTP(mx_host, timeout=10) as smtp:
                    ...
                    # Set up proxy for SMTP connection
                    smtp.connect(mx_host, 25)  # Connect using the default SMTP port
                    smtp.starttls()
                    smtp.set_debuglevel(1)  # For debugging purposes

                    # Authenticate via proxy if needed
                    smtp.set_proxy(self.proxies)
